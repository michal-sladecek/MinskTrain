    ...
    render() {
        ...
        return (
            ...
            <g transform = {this.props.transform}>
                ...
                <line x1="25" y1="0" x2="25" y2="40" style={style} />
                {tracks}
                <path d="M7 15 h-3 v-3 z" transform='rotate(45 20 20)'/>
            </g>
            </svg>
        )
    }
...
export const LRMod = React.createClass({
    render() {
        return (
             <UDMod transform='rotate(90 20 20)'/>
        )
    }
})
    ...
    render() {
        ...
        return (
            ...
            <g transform = {this.props.transform}>
                ...
                <line x1="25" y1="0" x2="25" y2="40" style={style} />
                {tracks}
                <path d="M7 15 h3 v3 z" transform='rotate(45 20 20)'/>
            </g>
            </svg>
        )
    }
...
export const LRDiv = React.createClass({
    render() {
        return (
             <UDDiv transform='rotate(90 20 20)'/>
        )
    }
})