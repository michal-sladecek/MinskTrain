...
export const DLUswitch = React.createClass({
    render() {
        let transform=''
        if(this.props.transform){
            transform=this.props.transform
        ...
        return (
            ...
            <g transform = {this.props.transform}>
                <line x1="15" y1="0" x2="15" y2="40" style={styleMain} />
                <line x1="25" y1="0" x2="25" y2="40" style={styleMain} />
                <path d="M25 40 Q 25 15 0 15" style={styleSecondary}/>
                <path d="M15 40 Q 15 25 0 25" style={styleSecondary}/>
            </g>
            </svg>
        )
    }
...
export const LURswitch = React.createClass({
    render() {
        return (
            <DLUswitch transform='rotate(90 20 20)'/>
        )
    }
})

export const RDLswitch = React.createClass({
    render() {
        return (
            <DLUswitch transform='rotate(270 20 20)'/>
        )
    }
})

export const URDswitch = React.createClass({
    render() {
        return (
            <DLUswitch transform='rotate(180 20 20)'/>
        )
    }
})